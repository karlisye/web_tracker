...
const WebsiteInfo = ({ setIsSeeMoreActive, isSeeMoreActive, websiteID }) => {
  ...
  if (!isSeeMoreActive) return;

  return (
    <div onClick={() => setIsSeeMoreActive(false)} className='fixed w-screen h-screen top-0 left-0 flex justify-center items-center backdrop-blur-sm z-1'>
