      ...
      <SnapContainer>
        ...
        <SnapItem>
          ...
          <div className='grid grid-cols-2 gap-8'>
            <div className='bg-primary-light rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-12 flex flex-col justify-center'>
            ...
            <div 
              className='bg-secondary rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 flex flex-col items-center justify-center'
            >
              <img 
        ...
        <SnapItem>
          ...
          <div className='grid grid-cols-2 gap-8'>
            <div 
              className='bg-accent rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 flex flex-col items-center justify-center'
            >
              <img 
                onClick={handleImageClick}
        ...
        <SnapItem>
          ...
          <div className='grid grid-cols-2 gap-8'>
            <div className='bg-secondary rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-12 flex flex-col justify-center'>
            ...
            <div 
              className='bg-primary-light rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 flex flex-col items-center justify-center'
            >
              <img 
                onClick={handleImageClick}
          ...
          <div className='flex flex-col items-center justify-center h-full text-center'>
            <div className='bg-primary rounded-3xl shadow-2xl p-16 max-w-4xl'>
              ...
              <div className='flex gap-6 justify-center mb-8'>
                ...
                <Link 
                  to="/setup"
                  className='bg-secondary text-primary font-bold text-xl px-10 py-4 rounded-full shadow-lg hover:shadow-xl hover:bg-secondary-dark hover:scale-105 transition-all duration-300'
                >
                  View Setup Guide
                </Link>
              </div>
              ...
              <div className='grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/20'>
                ...
                <div className='text-center'>
                  <div className='text-secondary text-4xl font-bold mb-2'>Private</div>
                  <div className='text-white text-sm'>Your Data Stays Yours</div>
                </div>
                <div className='text-center'>
                  <div className='text-secondary text-4xl font-bold mb-2'>5 Min</div>
      ...
      {isImageModalOpen && (
        ...
        >
          <div className='relative max-w-6xl w-full'>
            <button
              className='absolute -top-12 right-0 text-white text-4xl font-bold hover:text-accent transition'
              onClick={() => setIsImageModalOpen(false)}
            >
              ×
            </button>
